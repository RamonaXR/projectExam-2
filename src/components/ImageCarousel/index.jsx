 ...
 * using next/prev buttons and navigation dots. Additionally, clicking on an image
 * will open a modal to preview the image in a larger view.
 *
 * @component
...
export default function ImageCarousel({ images, fallback }) {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <Modal isOpen={isModalOpen} onClose={closePreview}>
          <SafeImage
            src={previewImage}
            alt="Preview"
            fallback={fallback}
